...
\begin{itemize}
    ...
    \item Final demonstration. Students will be required to demonstrate their project to the class at the end of the semester.
\end{itemize}
...
\begin{itemize}
    ...
    \item Three programming assignments (projects) are worth 75\% split evenly across all three projects.
    \item Final demonstration is worth 10\%.
\end{itemize}
...
If you are unable to attend class, you must notify the instructor in advance with a valid reason.
Failing to do so will result in a penalty to your final grade.
...
The instructor will make every effort to respond to student emails within two business days.
